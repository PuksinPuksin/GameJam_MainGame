...
{
    [SerializeField] private Slider masterVoulmeSlider;
    ...
    private void Update()
    {
        masterVoulme = masterVoulmeSlider.value * 100;
        fxVoulme = fxSlider.value * 100;
    }

    public float MasterVolume => masterVoulme;
    public float BGMVolume => bgmVolume * MasterVolume;
    public float FxVoulme => fxVoulme * MasterVolume;
    ...
    private void Awake()
    {
        ...
        foreach (var audioClip in Resources.LoadAll<AudioClip>("Sound/Fx")) // Resource 폴더에있는 사운드들 담아두기
        {
